...
cursor.execute(''' INSERT INTO MenuData(id, category, name, desc, price, image)  
VALUES(25, "fruitJuice", "Mango Tango", "A rich mixture of mango, passion fruit and apple.",
10.00, "../images/mangoTango.png")''')

cursor.execute(''' INSERT INTO MenuData(id, category, name, desc, price, image)  
VALUES(26, "fruitJuice", "Golden Passion", "Sweet pineapple, passion fruit, guava with a touch of mint leaves",
13.00, "../images/goldenPassion.png")''')

cursor.execute(''' INSERT INTO MenuData(id, category, name, desc, price, image)  
VALUES(27, "fruitJuice", "Pink Lady", "Dragon Fruit, Pear, Grapes, topped with mint leaf.",
10.00, "../images/pinkLady.png")''')

cursor.execute(''' INSERT INTO MenuData(id, category, name, desc, price, image)  
VALUES(28, "fruitJuice", "Greenty Minty", "A mix of green apple and kiwi with mint leaf and lime.",
